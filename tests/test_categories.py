...
class TestCredentials(TestCase):
    ...
    def test_get_cat_tree(self, mock_api_get):
        ...
        self.assertEqual(self.cats_tree['rootCategoryNode']['childCategoryTreeNodes'], cat_tree)
    ...
    def test_get_top_categories(self, mock_get_cat_tree, mock_get_cat_tree_id, mock_access_token):
        mock_get_cat_tree.return_value = self.cats_tree['rootCategoryNode']['childCategoryTreeNodes']
        ...
        mock_get_cat_tree_id.assert_called_once_with(api, expected_headers, expected_params)
